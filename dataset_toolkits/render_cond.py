...
def _render_cond(file_path, sha256, render_object_path, output_dir, num_views):
...
if __name__ == '__main__':
    ...
    func = partial(_render_cond, render_object_path=opt.render_object_path, output_dir=opt.output_dir, num_views=opt.num_views)
