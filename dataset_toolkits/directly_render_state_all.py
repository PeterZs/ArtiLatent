...
if __name__ == '__main__':
    ...
    with open('/mnt/slurm_home/hhchen/cageplus/indexes/data_split_dyn_slat_all_0507_remaining.json', 'r') as f:
    ...
    for obj in train_objs:
        ...
        # if  os.path.exists(os.path.join(output_dir, '000_000.png')):
