...
BLENDER_INSTALLATION_PATH = '/mnt/slurm_home/hhchen/TRELLIS' #'/tmp'
...
def _render(file_path, sha256, render_object_path, output_dir, num_views):
...
if __name__ == '__main__':
    ...
    # @chh: process partnet-mobility data
    # import pdb; pdb.set_trace()
    print('opt.render_object_path:', opt.render_object_path)
    # sublists = opt.render_object_path.split(" ; ")
    # object_paths = [sublist.split(" ") for sublist in sublists]
    # print('object_paths:', object_paths)

    func = partial(_render, render_object_path=opt.render_object_path, output_dir=opt.output_dir, num_views=opt.num_views)
    # 
